<section id="about" class="section bg-blue-50 dark:bg-gray-800 ">
    <div class="container mx-auto">
        <div class="flex flex-col xl:flex-row gap-24">
            <img class="object-contain w-1/6 md:mx-auto lg:mx-0 rounded-full" src="/img/me.jpg"
                alt="About img" />
            <div class="flex flex-col items-center text-center lg:items-start lg:text-left">
                <div class="flex flex-col">
                    ...
                    <p class="mb-4 text-accent">Junior PHP Developer.</p>
                    <hr class="mb-8 opacity-90 dark:opacity-5" />
                    <p class="mb-8 text-blue-900 dark:text-white">
