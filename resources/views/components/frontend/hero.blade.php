<section id="home"
    class="section flex items-center bg-indigo-50 dark:bg-slate-800 lg:h-[90vh] overflow-hidden">
    <div class="container mx-auto h-full ">
        <div class="flex flex-col lg:flex-row items-center h-full pt-8">
            <div class="flex-1 flex flex-col items-center lg:items-start">
                <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Bechir! 👋</p>
                <h1
                    class="
                        text-4xl
                        leading-[44px]
                        ...
                        md:tracking-[-2px]
                        ">
                    Im a Computer Science Enthusiast 
                </h1>
                <p
                    class="
                    pt-4
                    ...
                    dark:text-white
                    ">
                    Currently 2nd year student at the higher institute of computer science El Kef (ISIK). I'm a PHP junior dev
                </p>
                <a href="https://wa.me/21650727509">
                <button
                    class="
                        btn btn-md
                        bg-accent
                ...
                <div class="pt-12">
                    ...
                    <div class="flex items-center mb-6">
                        <a class="
                                ...
                                sm:mr-4
                                "
                            href="https://www.facebook.com/Ferjaboss/">
                  ...
                  sm:mr-4
                "
                            href="https://twitter.com/Bechir_fer">
                  ...
                  sm:mr-4
                "
                            href="https://www.youtube.com/channel/UCmgsnzD9Ts7DenV9VX7ncxQ">
                            <svg width="16" height="12" viewBox="0 0 16 12" class="fill-current">
                                <path
