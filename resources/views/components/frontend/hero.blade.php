    ...
    <div class="container mx-auto h-full ">
        <div class="flex flex-col lg:flex-row items-center h-full pt-8">
            <div class="flex-1 flex flex-col items-center lg:items-start">
                <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Bechir Ferjani! 👋</p>
                <h1
                    class="
                        text-4xl
                        leading-[44px]
                ...
                <p
                    ...
                    dark:text-white
                    ">
                    with expertise in Backend Development, Specialized in Spring Boot and Angular. 
                ...
                <button
                    class="
                        ...
                        md:btn-lg
                        transition-all flex flex-row items-center gap-3
                        ">
